...
export const ANIMATION_PROGRESS_MESSAGE =
  "This move is available, but its animation is still being refined.";
...
export interface Preset {
  ...
  /** Optional animation-readiness marker shown in the movement library. */
  status?: "animation-progress";
  source: string;
}
...
export const PRESETS: Preset[] = [
  ...
  { id: "dance-phrase", label: "Dance phrase (8-count)", domain: "Dance", bodyPart: "Full body", target: "Full body", equipment: "Body weight", difficulty: "Intermediate", status: "animation-progress", source: dancePhrase },
  ...
  { id: "shoulder-abduction", label: "Shoulder abduction (ROM)", domain: "Education", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: shoulderAbduction },
  ...
  { id: "mountain-climber", label: "Mountain climber", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Body weight", difficulty: "Intermediate", status: "animation-progress", source: mountainClimber },
  ...
  { id: "bicycle-crunch", label: "Bicycle crunch", domain: "Fitness", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Intermediate", status: "animation-progress", source: bicycleCrunch },
  ...
  { id: "superman", label: "Superman", domain: "Fitness", bodyPart: "Back", target: "Spinal erectors", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: superman },
  ...
  { id: "pull-up", label: "Pull-up", domain: "Fitness", bodyPart: "Back", target: "Lats", equipment: "Bar", difficulty: "Advanced", status: "animation-progress", source: pullUp },
  ...
  { id: "triceps-dips", label: "Triceps dips (bars)", domain: "Fitness", bodyPart: "Upper arms", target: "Triceps", equipment: "Bars", difficulty: "Intermediate", status: "animation-progress", source: tricepsDips },
  ...
  { id: "knee-flexion", label: "Knee flexion (ROM)", domain: "Education", bodyPart: "Upper legs", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: kneeFlexion },
  ...
  { id: "elbow-forearm", label: "Elbow flexion & forearm rotation", domain: "Education", bodyPart: "Upper arms", target: "Biceps", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: elbowForearm },
  ...
  { id: "shoulder", label: "Shoulder flexion (ROM)", domain: "Physiotherapy", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: shoulder },
  ...
  { id: "shoulder-rolls", label: "Shoulder rolls", domain: "Desk & posture", bodyPart: "Shoulders", target: "Trapezius", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: shoulderRolls },
  ...
  { id: "overhead-reach", label: "Overhead reach reset", domain: "Desk & posture", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: overheadReach },
  ...
  { id: "arm-circles", label: "Arm circles", domain: "Warm-up", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: armCircles },
  ...
  { id: "port-de-bras", label: "Port de bras", domain: "Dance", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: portDeBras },
  ...
  { id: "biceps", label: "Biceps curl", domain: "Fitness", bodyPart: "Upper arms", target: "Biceps", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: biceps },
  ...
  // --- Reach-to-target IK ---
  { id: "touch-toes", label: "Touch your toes", domain: "Mobility", bodyPart: "Back", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: touchToes },
  { id: "cross-body-reach", label: "Cross-body reach", domain: "Physiotherapy", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: crossBodyReach },

  // --- Lying & seated poses ---
  { id: "glute-bridge", label: "Glute bridge", domain: "Physiotherapy", bodyPart: "Upper legs", target: "Glutes", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: gluteBridge },
  ...
  { id: "cobra", label: "Cobra", domain: "Yoga", bodyPart: "Back", target: "Spinal erectors", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: cobra },
  ...
  { id: "dead-hang", label: "Dead hang (bar)", domain: "Fitness", bodyPart: "Back", target: "Lats", equipment: "Bar", difficulty: "Beginner", status: "animation-progress", source: deadHang },
  { id: "hanging-knee-raise", label: "Hanging knee raise (bar)", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Bar", difficulty: "Intermediate", status: "animation-progress", source: hangingKneeRaise },

  // --- Hand / finger rig ---
  { id: "make-a-fist", label: "Make a fist", domain: "Hand therapy", bodyPart: "Hands", target: "Forearms", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: makeAFist },
  { id: "pinch-grip", label: "Pinch grip", domain: "Hand therapy", bodyPart: "Hands", target: "Forearms", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: pinchGrip },
  { id: "finger-spell", label: "Finger-spelling (approx.)", domain: "Sign language", bodyPart: "Hands", target: "Forearms", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: fingerSpell },
  { id: "hand-wave", label: "Hand wave", domain: "Sign language", bodyPart: "Hands", target: "Forearms", equipment: "Body weight", difficulty: "Beginner", status: "animation-progress", source: handWave },
