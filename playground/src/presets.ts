...
import superheroLanding from "../../spec/examples/superhero-landing.posecode?raw";
...
export type PresetStatus = "ready" | "experimental";

export const ANIMATION_PROGRESS_MESSAGE =
  "Experimental preview: this animation is still being refined and has not cleared the launch-quality gate.";
...
export interface Preset {
  ...
  /** Required launch-readiness state shown everywhere this movement appears. */
  status: PresetStatus;
  source: string;
}
...
export const PRESETS: Preset[] = [
  ...
  { id: "good-morning", label: "Good morning (hinge)", domain: "Physiotherapy", bodyPart: "Back", target: "Hamstrings", equipment: "Body weight", difficulty: "Intermediate", status: "ready", source: goodMorning },
  { id: "chest-opener", label: "Chest opener", domain: "Desk & posture", bodyPart: "Chest", target: "Pectorals", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: chestOpener },

  // --- Strength & core (coverage-gap batch) ---
  { id: "plank-hold", label: "Plank hold", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: plankHold },
  { id: "mountain-climber", label: "Mountain climber", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Body weight", difficulty: "Intermediate", status: "experimental", source: mountainClimber },
  { id: "crunch", label: "Crunch", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: crunch },
  ...
  { id: "knee-flexion", label: "Knee flexion (ROM)", domain: "Education", bodyPart: "Upper legs", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: kneeFlexion },
  { id: "spine-rotation", label: "Spine rotation (ROM)", domain: "Education", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: spineRotation },
  { id: "elbow-forearm", label: "Elbow flexion & forearm rotation", domain: "Education", bodyPart: "Upper arms", target: "Biceps", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: elbowForearm },

  // --- Physiotherapy / rehab ---
  { id: "heel-raises", label: "Heel raises", domain: "Physiotherapy", bodyPart: "Lower legs", target: "Calves", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: heelRaises },
  { id: "hamstring-curl", label: "Standing hamstring curl", domain: "Physiotherapy", bodyPart: "Upper legs", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: hamstringCurl },
  { id: "hip-abduction", label: "Standing hip abduction", domain: "Physiotherapy", bodyPart: "Upper legs", target: "Glutes", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: hipAbduction },
  { id: "shoulder", label: "Shoulder flexion (ROM)", domain: "Physiotherapy", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: shoulder },
  { id: "neck", label: "Neck rotation", domain: "Physiotherapy", bodyPart: "Neck", target: "Neck", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: neck },

  // --- Desk / workplace wellness ---
  { id: "posture", label: "Desk posture reset", domain: "Desk & posture", bodyPart: "Back", target: "Spinal erectors", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: posture },
  { id: "twist", label: "Standing spinal twist", domain: "Desk & posture", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: twist },
  ...
  { id: "bent-over-row", label: "Bent-over row (hinge)", domain: "Fitness", bodyPart: "Back", target: "Lats", equipment: "Body weight", difficulty: "Intermediate", status: "ready", source: bentOverRow },
  { id: "biceps", label: "Biceps curl", domain: "Fitness", bodyPart: "Upper arms", target: "Biceps", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: biceps },
  { id: "lateral", label: "Lateral raise", domain: "Fitness", bodyPart: "Shoulders", target: "Deltoids", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: lateral },
  { id: "fold", label: "Standing roll-down", domain: "Mobility", bodyPart: "Back", target: "Spinal erectors", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: fold },
  { id: "chair", label: "Chair pose", domain: "Yoga", bodyPart: "Upper legs", target: "Quadriceps", equipment: "Body weight", difficulty: "Intermediate", status: "ready", source: chair },
  { id: "sidebend", label: "Standing side bend", domain: "Yoga", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: sideBend },

  // --- Reach-to-target IK ---
  { id: "touch-toes", label: "Touch your toes", domain: "Mobility", bodyPart: "Back", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: touchToes },
  { id: "cross-body-reach", label: "Cross-body reach", domain: "Physiotherapy", bodyPart: "Core", target: "Obliques", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: crossBodyReach },

  // --- Lying & seated poses ---
  { id: "glute-bridge", label: "Glute bridge", domain: "Physiotherapy", bodyPart: "Upper legs", target: "Glutes", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: gluteBridge },
  { id: "dead-bug", label: "Dead bug", domain: "Physiotherapy", bodyPart: "Core", target: "Abdominals", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: deadBug },
  { id: "cobra", label: "Cobra", domain: "Yoga", bodyPart: "Back", target: "Spinal erectors", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: cobra },
  { id: "seated-forward-fold", label: "Seated forward fold", domain: "Yoga", bodyPart: "Back", target: "Hamstrings", equipment: "Body weight", difficulty: "Beginner", status: "ready", source: seatedForwardFold },

  // --- Props: chair / wall / bar ---
  { id: "sit-to-stand", label: "Sit to stand (chair)", domain: "Functional", bodyPart: "Upper legs", target: "Quadriceps", equipment: "Chair", difficulty: "Beginner", status: "ready", source: sitToStand },
  { id: "box-squat", label: "Box squat (chair)", domain: "Fitness", bodyPart: "Upper legs", target: "Quadriceps", equipment: "Chair", difficulty: "Beginner", status: "ready", source: boxSquat },
  { id: "wall-sit", label: "Wall sit (wall)", domain: "Fitness", bodyPart: "Upper legs", target: "Quadriceps", equipment: "Wall", difficulty: "Beginner", status: "ready", source: wallSit },
  { id: "dead-hang", label: "Dead hang (bar)", domain: "Fitness", bodyPart: "Back", target: "Lats", equipment: "Bar", difficulty: "Beginner", status: "experimental", source: deadHang },
  { id: "hanging-knee-raise", label: "Hanging knee raise (bar)", domain: "Fitness", bodyPart: "Core", target: "Abdominals", equipment: "Bar", difficulty: "Intermediate", status: "experimental", source: hangingKneeRaise },

  // --- Hand / finger rig ---
  { id: "make-a-fist", label: "Make a fist", domain: "Hand therapy", bodyPart: "Hands", target: "Forearms", equipment: "Body weight", difficulty: "Beginner", status: "experimental", source: makeAFist },
