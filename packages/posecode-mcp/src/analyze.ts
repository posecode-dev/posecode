...
/** Production playground that renders a shared `.posecode` link. */
export const DEFAULT_BASE_URL = "https://posecode.org";
...
/** Parse and ROM-validate a `.posecode` document into a structured summary. */
export function analyzePosecode(source: string): ValidationSummary {
 ...
 */
export function renderPosecode(
  source: string,
  baseUrl: string = DEFAULT_BASE_URL,
): RenderResult {
  const summary = analyzePosecode(source);
